 ...
 */
export declare class TextPacket {
    type: number;
    strings: string[];
    /**
     ...
     */
    constructor(type: number, strings: string[]);
    /**
     ...
     */
    static from(type: number, ...strings: string[]): TextPacket;
    /**
     * Creates a TextPacket class from a Buffer.
     * @param packet The buffer to convert.
     */
    static fromBuffer(packet: Buffer): TextPacket;
    /**
